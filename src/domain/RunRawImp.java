...
class RunRawImp implements RunRaw {
    ...
    RunRawImp(Integer idLine, String lineName, Integer idConvoy, Integer idStaff, String staffName, String staffSurname, Integer idFirstStation, String firstStationName, Timestamp timeDeparture) {
        this.idLine = idLine;
