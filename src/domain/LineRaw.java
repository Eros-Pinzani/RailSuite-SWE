...
public interface LineRaw {
     ...
     */
    static LineRaw of(int idLine, String lineName, int idFirstStation, String firstStationLocation, int idLastStation, String lastStationLocation) {
        return new LineRawImp(idLine, lineName,idFirstStation, firstStationLocation, idLastStation, lastStationLocation);
    }
